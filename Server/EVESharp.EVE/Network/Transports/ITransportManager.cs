...
public interface ITransportManager
{
    ...
    /// </summary>
    IReadOnlyList <IMachoTransport> UnauthenticatedTransports { get; }
    /// <summary>
    /// The registered and validated client transports
    /// </summary>
    ConcurrentDictionary <int, MachoClientTransport> ClientTransports { get; }
    /// <summary>
    /// The registered and validated node transports
    /// </summary>
    ConcurrentDictionary <long, MachoNodeTransport> NodeTransports { get; }
    /// <summary>
    /// The registered and validated proxy transports
    /// </summary>
    ConcurrentDictionary <long, MachoProxyTransport> ProxyTransports { get; }
    /// <summary>
    /// Full list of active transports for this node
    /// </summary>
    IReadOnlyList <IMachoTransport> TransportList { get; }
    /// <summary>
